defmodule UAInspector.Benchmark.ParseOS do
  ...
  def run do
    Benchee.run(
      %{
        "Parse OS: desktop" => fn -> UAInspector.Parser.OS.parse(@agent_desktop) end,
        "Parse OS: smartphone" => fn -> UAInspector.Parser.OS.parse(@agent_smartphone) end,
        "Parse OS: tablet" => fn -> UAInspector.Parser.OS.parse(@agent_tablet) end,
        "Parse OS: unknown" => fn -> UAInspector.Parser.OS.parse(@agent_unknown) end
      },
