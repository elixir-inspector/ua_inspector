defmodule UAInspector.Benchmark.ParseDevice do
  ...
  def run do
    Benchee.run(
      %{
        "Parse Device: desktop" => fn -> UAInspector.Parser.Device.parse(@agent_desktop) end,
        "Parse Device: smartphone" => fn -> UAInspector.Parser.Device.parse(@agent_smartphone) end,
        "Parse Device: tablet" => fn -> UAInspector.Parser.Device.parse(@agent_tablet) end,
        "Parse Device: unknown" => fn -> UAInspector.Parser.Device.parse(@agent_unknown) end
      },
