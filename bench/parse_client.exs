defmodule UAInspector.Benchmark.ParseClient do
  ...
  def run do
    Benchee.run(
      %{
        "Parse Client: desktop" => fn -> UAInspector.Parser.Client.parse(@agent_desktop) end,
        "Parse Client: smartphone" => fn -> UAInspector.Parser.Client.parse(@agent_smartphone) end,
        "Parse Client: tablet" => fn -> UAInspector.Parser.Client.parse(@agent_tablet) end,
        "Parse Client: unknown" => fn -> UAInspector.Parser.Client.parse(@agent_unknown) end
      },
